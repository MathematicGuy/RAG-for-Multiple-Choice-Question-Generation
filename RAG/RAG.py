...
def build_rag_chain(docs, embeddings, llm):
    ...
    prompt_template =  PromptTemplate.from_template("""
        ...
        Return your response as a valid JSON object with exactly three keys: "context", "question", and "answer".

        - The "context" key should contain the retrieved context.
        - The "question" key should contain the user's question.
        - The "answer" key should contain your answer to the question.
    ...
    #? next test: for loop 10 times to check if output
